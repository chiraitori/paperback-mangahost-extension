 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaHostParser = void 0;
class MangaHostParser {
    /**
     * Parse manga detail into Paperback SourceManga
     */
    static parseMangaDetails(json, mangaId, App) {
        const manga = json.data?.manga || json.manga || json;
     ...
     */
    static parseSearchResults(json, App) {
...
exports.MangaHostParser = MangaHostParser;

},{}],63:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaHostR18 = exports.MangaHostR18Info = void 0;
const types_1 = require("@paperback/types");
const MangaHostParser_1 = require("../MangaHost/MangaHostParser");
exports.MangaHostR18Info = {
    version: '1.0.0',
    name: 'MangaHost R18',
    icon: 'icon.png',
    author: 'chiraitori',
...
class MangaHostR18 extends types_1.Source {
    constructor() {
        super(...arguments);
        this.apiBase = exports.MangaHostR18Info.websiteBaseURL.replace(/\/$/, '');
    ...
    async getChapters(mangaId) {
        const json = await this.getMangaResponse(mangaId);
        return MangaHostParser_1.MangaHostParser.parseChapterList(json, mangaId, App, 'MangaHost R18');
    }
    ...
    async getHomePageSections(sectionCallback) {
        ...
        try {
            ...
            if (data?.featured && data.featured.length > 0) {
                featuredSection.items = data.featured.map((m) => App.createPartialSourceManga({
                    mangaId: m.slug || m.id,
                    image: m.coverUrl || '',
                    title: m.title,
            ...
            if (data?.latest && data.latest.length > 0) {
                latestSection.items = data.latest.map((m) => App.createPartialSourceManga({
                    mangaId: m.slug || m.id,
                    image: m.coverUrl || '',
                    title: m.title,
                    subtitle: m.lastChapterNumber !== undefined ? `Ch. ${m.lastChapterNumber}` : undefined
            ...
            if (data?.popular && data.popular.length > 0) {
                popularSection.items = data.popular.map((m) => App.createPartialSourceManga({
                    mangaId: m.slug || m.id,
                    image: m.coverUrl || '',
                    title: m.title,
                    subtitle: m.lastChapterNumber !== undefined ? `Ch. ${m.lastChapterNumber}` : undefined
...
exports.MangaHostR18 = MangaHostR18;

},{"../MangaHost/MangaHostParser":62,"@paperback/types":61}]},{},[63])(63)
});
